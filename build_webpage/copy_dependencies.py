...
shutil.copy2("build_webpage/favicon-96x96.png", "webpage/favicon-96x96.png")
shutil.copy2("build_webpage/favicon.svg", "webpage/favicon.svg")
shutil.copy2("build_webpage/apple-touch-icon.png", "webpage/apple-touch-icon.png")
